function hessian=computeCostHessian(z,data)
...
switch data.options.transcription
    ...
    case {'multiple_shooting'}
        ...
        hessian=multipleShooting('costHessian',z,data);
    ...
    case {'direct_collocation','direct_collocation_intres_reg'}
        ...
        switch data.options.discretization
            ...
            case{'globalLGR','hpLGR'} % p/hp Transcription Method
                ...
                hessian=directCollocationLGR('costHessian',z,data,1);

            case {'resMinConstructionForSolution'}

                hessian=resMinConstructionForSolution('costHessian',z,data);   

            case {'resMinInterpolationForSolution'}

%                 hessian=resMinInterpolationForSolution('hessian',z,data);   
                hessian=resMinOptimization('costHessian',z,data,1);   

            otherwise % h Transcription Method

                hessian=directCollocation('costHessian',z,data,1);
