function hessian=resMin_hessianCD_LGR_ModeMinRes_Adigator(L,g,X_Np1,U_Np1,P,T_Np1,E,b,x0,xf,u0,uf,p,t0,tf,t_segment_end,t_segment,data,ResNorm_vec,Res_vec)
%resMin_hessianCD_LGR_ModeMinRes_Adigator - Hessian computation for
...
% Compute Res_zz
% ----------------
adjoint_Res=lambda(end-n-ng_eq+1:end);
