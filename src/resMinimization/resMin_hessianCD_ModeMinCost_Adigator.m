function hessian=resMin_hessianCD_ModeMinCost_Adigator(L,g,X,U,P,T,E,b,x0,xf,u0,uf,p,t0,tf,data,Res_vec)
%resMin_hessianCD_ModeMinCost_Adigator - Hessian computation for
%integrated residual minimization (alternating method: cost
%minimization) with Adigator
%
% Syntax:   hessian=resMin_hessianCD_ModeMinCost_Adigator(L,g,X,U,P,T,E,b,x0,xf,u0,uf,p,t0,tf,data,Res_vec)
%
