function hessian=resMin_hessianCD_LGR_ModeMinWeightedCostRes(L,g,X_Np1,U_Np1,P,T_Np1,E,b,x0,xf,u0,uf,p,t0,tf,t_segment_end,t_segment,data)
...
% -------------------------------------?
hessc=gzz+bzz+Resz;
hessian=sigma*(Lzz+Ezz+ResNormz)+hessc;
