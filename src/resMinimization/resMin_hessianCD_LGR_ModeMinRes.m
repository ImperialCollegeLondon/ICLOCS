function hessian=resMin_hessianCD_LGR_ModeMinRes(L,g,X_Np1,U_Np1,P,T_Np1,E,b,x0,xf,u0,uf,p,t0,tf,t_segment_end,t_segment,data)
%resMin_hessianCD_LGR_ModeMinRes - Hessian computation for
%integrated residual minimization (alternating method: residual
%minimization) using finite difference
%
% Syntax:   hessian=resMin_hessianCD_LGR_ModeMinRes(L,g,X_Np1,U_Np1,P,T_Np1,E,b,x0,xf,u0,uf,p,t0,tf,t_segment_end,t_segment,data)
%
        ...
        for k1=1:size(data.idx_perturb_hes,2)
            ...
            for k2=1:k_end
             ...
             if j<=n 
              ...
              if j==i && k1==k2
                [ResNorm_o, Res_o]=costResidualMin_ModeMinRes(X_Np1,U_Np1,P,DT/2*T_Np1+k0/2,data);
                [ResNorm_p, Res_p]=costResidualMin_ModeMinRes(X_Np1+dx1.*purb_1_x,U_Np1+du1.*purb_1_u,P+dp1,(DT+dtf_1-dt0_1)/2*T_Np1+(k0+dtf_1+dt0_1)/2,data);
                [ResNorm_m, Res_m]=costResidualMin_ModeMinRes(X_Np1-dx1.*purb_1_x,U_Np1-du1.*purb_1_u,P-dp1,(DT-dtf_1+dt0_1)/2*T_Np1+(k0-dtf_1-dt0_1)/2,data);
                ...
                [ResNorm_pp, Res_pp]=costResidualMin_ModeMinRes(X_Np1+dx1.*purb_1_x+dx2.*purb_2_x,U_Np1+du1.*purb_1_u+du2.*purb_2_u,P+dp1+dp2,(DT+dtf_1-dt0_1+dtf_2-dt0_2)/2*T_Np1+(k0+dtf_1+dt0_1+dtf_2+dt0_2)/2,data);
                [ResNorm_pm, Res_pm]=costResidualMin_ModeMinRes(X_Np1+dx1.*purb_1_x-dx2.*purb_2_x,U_Np1+du1.*purb_1_u-du2.*purb_2_u,P+dp1-dp2,(DT+dtf_1-dt0_1-dtf_2+dt0_2)/2*T_Np1+(k0+dtf_1+dt0_1-dtf_2-dt0_2)/2,data);
                [ResNorm_mp, Res_mp]=costResidualMin_ModeMinRes(X_Np1-dx1.*purb_1_x+dx2.*purb_2_x,U_Np1-du1.*purb_1_u+du2.*purb_2_u,P-dp1+dp2,(DT-dtf_1+dt0_1+dtf_2-dt0_2)/2*T_Np1+(k0-dtf_1-dt0_1+dtf_2+dt0_2)/2,data);
                [ResNorm_mm, Res_mm]=costResidualMin_ModeMinRes(X_Np1-dx1.*purb_1_x-dx2.*purb_2_x,U_Np1-du1.*purb_1_u-du2.*purb_2_u,P-dp1-dp2,(DT-dtf_1+dt0_1-dtf_2+dt0_2)/2*T_Np1+(k0-dtf_1-dt0_1-dtf_2-dt0_2)/2,data);
