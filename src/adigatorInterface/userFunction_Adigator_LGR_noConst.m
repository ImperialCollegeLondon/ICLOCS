function [ const ] = userFunction_Adigator_LGR_noConst( X_in,U,p,t,data)
%userFunction_Adigator_LGR_noConst - Adigator template for user defined function (dynamics constraints) with direct collocation method (hp-type)
%
% Syntax:  [ const ] = userFunction_Adigator_LGR_noConst( X_in,U,p,t,data)
%
