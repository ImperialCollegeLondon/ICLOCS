function [ const ] = userFunction_Adigator_LGR_All( X_in,U,p,t,data)
%userFunction_Adigator_LGR_All - Adigator template for user defined function (dynamics + equality + inequality path constraints) with direct collocation method (hp-type)
%
% Syntax:  [ const ] = userFunction_Adigator_LGR_All( X_in,U,p,t,data)
%
...
[dynF,eqConst,neqConst]=f(X,U,P,T,vdat);
