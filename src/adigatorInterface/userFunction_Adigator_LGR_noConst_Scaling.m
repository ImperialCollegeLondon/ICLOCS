function [ const ] = userFunction_Adigator_LGR_noConst_Scaling( X_in,U,p,t,data)
%userFunction_Adigator_LGR_noConst_Scaling - Adigator template for user defined function (dynamics constraints) with direct collocation method (hp-type) and automatic scaling
%
% Syntax:  [ const ] = userFunction_Adigator_LGR_noConst_Scaling( X_in,U,p,t,data)
%
