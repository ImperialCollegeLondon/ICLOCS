function [ const ] = userFunction_Adigator_All_Scaling( X_in,U,p,t,data)
%userFunction_Adigator_All_Scaling - Adigator template for user defined function (dynamics + equality + inequality path constraints) with direct collocation method (h-type) and automatic scaling
%
% Syntax:  [ const ] = userFunction_Adigator_All_Scaling( X_in,U,p,t,data)
%
