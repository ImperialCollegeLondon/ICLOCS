function [ const ] = userFunction_Adigator_LGR_oneConst_Scaling( X_in,U,p,t,data)
%userFunction_Adigator_LGR_oneConst_Scaling - Adigator template for user defined function (dynamics + equality or inequality path constraints) with direct collocation method (hp-type) and automatic scaling
%
% Syntax:  [ const ] = userFunction_Adigator_LGR_oneConst_Scaling( X_in,U,p,t,data)
%
