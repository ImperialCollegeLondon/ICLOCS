function [ const ] = userFunction_Adigator_oneConst_Scaling( X_in,U,p,t,data)
%userFunction_Adigator_oneConst_Scaling - Adigator template for user defined function (dynamics + equality or inequality path constraints) with direct collocation method (h-type) and automatic scaling
%
% Syntax:  [ const ] = userFunction_Adigator_oneConst_Scaling( X_in,U,p,t,data)
%
...
%     p=(p-data.data.Pshift)./data.data.Pscale;
    ...
    [dynF_org,gConst]=f(X,U,P,T,vdat);
