...
if isfield(vdat,'Xscale')
        XU0f.x0=scale_variables_back( x0', vdat.Xscale, vdat.Xshift )';
        XU0f.xf=scale_variables_back( xf', vdat.Xscale, vdat.Xshift )';
        XU0f.u0=scale_variables_back( u0', vdat.Uscale, vdat.Ushift )';
        XU0f.uf=scale_variables_back( uf', vdat.Uscale, vdat.Ushift )';
else
        XU0f.x0=x0;
        XU0f.xf=xf;
        XU0f.u0=u0;
