...
global infoNLP data simtime solution tstep N_node settings_func
simtime=0; % initialize simulation time
tstep=0.1; % time step of simulation
N_node=20; % initial number of mesh points
settings_func=@settings_MinTimeClimbBryson_Phase1;

options= settings_func(N_node);                  % Get options and solver settings
[problem,guess]=MinTimeClimbBryson_Phase1;          % Fetch the problem definition
