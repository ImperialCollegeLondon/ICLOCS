...
cada2f1 = X_quad.dY(Gator1Data.Index19);
...
cada2f1 = U_quad.dY(Gator1Data.Index23);
...
cada2tempdY = delta_t.dY(Gator2Data.Index1);
cada2tf1 = cada1f2dY(Gator2Data.Index2);
cada2f1dY = -cada2tf1(:)./delta_t.f.^2.*cada2tempdY;
cada2f1 = cada1f2dY/delta_t.f;
cada1td1dY = cada2f1dY;
cada1td1(Gator1Data.Index31) = cada2f1;
cada1tf1dY = cada1f2dY(Gator2Data.Index3);
...
cada2f4 = delta_t.f^2;
cada2tempdY = cada2f4dY(Gator2Data.Index4);
cada2td1 = zeros(11264,1);
cada2td1(Gator2Data.Index5) = cada2f3dY./cada2f4;
cada2tf1 = cada2f3(Gator2Data.Index6);
cada2td1(Gator2Data.Index7) = cada2td1(Gator2Data.Index7) + -cada2tf1(:)./cada2f4.^2.*cada2tempdY;
cada2f5dY = cada2td1;
cada2f5 = cada2f3/cada2f4;
cada2tf1 = cada1tempdY(Gator2Data.Index8);
cada2f6dY = cada2tf1(:).*cada2f5dY;
cada2f6 = cada2f5.*cada1tempdY;
cada2f7dY = cada2f6dY;
cada2f7 = cada2f1 + cada2f6;
cada2td1 = zeros(19712,1);
cada2td1(Gator2Data.Index9) = cada2f7dY;
cada2td1(Gator2Data.Index10) = cada1td1dY(Gator2Data.Index11);
cada1td1dY = cada2td1;
cada1td1(Gator1Data.Index33) = cada2f7;
dX_quad.dYdY = cada1td1dY; dX_quad.dY = cada1td1;
...
cada2f1 = cada1tf1(:);
cada2f2 = cada1tempdY(Gator1Data.Index35);
...
cada2td1 = zeros(22624,1);
cada2td1(Gator2Data.Index26) = cada2f2dY;
...
cada1f14 = 2*cada1f5;
cada1tf1dY = cada1f3dY(Gator2Data.Index29);
cada1tf1 = cada1f3(Gator1Data.Index55);
cada1td1 =  zeros(1932,1);
cada2f1dY = cada1tf1dY;
cada2f1 = cada1tf1(:);
cada2tf1 = cada1f14dY(Gator2Data.Index30);
cada2f2dY = cada2tf1(:).*cada2f1dY;
cada2f2 = cada2f1.*cada1f14dY;
cada1td1dY = cada2f2dY;
cada1td1(Gator1Data.Index56) = cada2f2;
cada1tf1dY = cada1f14dY(Gator2Data.Index31);
cada1tf1 = cada1f14(Gator1Data.Index57);
cada2f1 = cada1td1(Gator1Data.Index58);
cada2f2dY = cada1tf1dY;
cada2f2 = cada1tf1(:);
cada2tf1 = cada1f3dY(Gator2Data.Index32);
cada2f3dY = cada2tf1(:).*cada2f2dY;
cada2f3 = cada2f2.*cada1f3dY;
cada2f4dY = cada2f3dY;
cada2f4 = cada2f1 + cada2f3;
cada2td1 = zeros(11312,1);
cada2td1(Gator2Data.Index33) = cada2f4dY;
cada2td1(Gator2Data.Index34) = cada1td1dY(Gator2Data.Index35);
cada1td1dY = cada2td1;
cada1td1(Gator1Data.Index58) = cada2f4;
...
cada1tf1dY = cada1f1dY(Gator2Data.Index36);
cada1tf1 = cada1f1(Gator1Data.Index59);
cada1td1 =  zeros(1932,1);
cada2f1dY = cada1tf1dY;
cada2f1 = cada1tf1(:);
cada2tf1 = cada1f6dY(Gator2Data.Index37);
cada2f2dY = cada2tf1(:).*cada2f1dY;
cada2f2 = cada2f1.*cada1f6dY;
cada1td1dY = cada2f2dY;
cada1td1(Gator1Data.Index60) = cada2f2;
cada1tf1dY = cada1f6dY(Gator2Data.Index38);
cada1tf1 = cada1f6(Gator1Data.Index61);
cada2f1 = cada1td1(Gator1Data.Index62);
cada2f2dY = cada1tf1dY;
cada2f2 = cada1tf1(:);
cada2tf1 = cada1f1dY(Gator2Data.Index39);
cada2f3dY = cada2tf1(:).*cada2f2dY;
cada2f3 = cada2f2.*cada1f1dY;
cada2f4dY = cada2f3dY;
cada2f4 = cada2f1 + cada2f3;
cada2td1 = zeros(11312,1);
cada2td1(Gator2Data.Index40) = cada2f4dY;
...
cada1tf2dY = cada1f1dY(Gator2Data.Index46);
cada1tf2 = cada1f1(Gator1Data.Index67);
cada2f1dY = cada1tf2dY;
cada2f1 = cada1tf2(:);
cada2tf2 = cada2f1(Gator2Data.Index47);
cada2f2dY = 1.*cada2tf2(:).^(1-1).*cada2f1dY;
cada2f2 = cada2f1.^1;
cada2f3dY = 2.*cada2f2dY;
cada2f3 = 2*cada2f2;
cada2tf1 = cada1f1dY(Gator2Data.Index48);
cada1f21dYdY = cada2tf1(:).*cada2f3dY;
cada1f21dY = cada2f3.*cada1f1dY;
cada1f21 = cada1f1.^2;
cada1tf2dY = cada1f3dY(Gator2Data.Index49);
cada1tf2 = cada1f3(Gator1Data.Index68);
cada2f1dY = cada1tf2dY;
cada2f1 = cada1tf2(:);
cada2tf2 = cada2f1(Gator2Data.Index50);
cada2f2dY = 1.*cada2tf2(:).^(1-1).*cada2f1dY;
cada2f2 = cada2f1.^1;
cada2f3dY = 2.*cada2f2dY;
cada2f3 = 2*cada2f2;
cada2tf1 = cada1f3dY(Gator2Data.Index51);
cada1f22dYdY = cada2tf1(:).*cada2f3dY;
...
cada2td1 = zeros(11552,1);
cada2td1(Gator2Data.Index52) = cada2f2dY;
...
Gp.dYdY = cada1f23dYdY; Gp.dY = cada1f23dY;
...
cada2td1 = zeros(45248,1);
cada2td1(Gator2Data.Index55) = cada1f20dYdY;
...
cada1f1 = 1:ng_eq.f;
Gp.dYdY = Gp.dYdY(Gator2Data.Index58);
...
cada2f1dY = cada1td1dY(Gator2Data.Index59);
cada2f1 = cada1td1(Gator1Data.Index77);
cada2f2dY = -Fp.dYdY;
cada2f2 = uminus(Fp.dY);
cada2td1 = zeros(49152,1);
cada2td1(Gator2Data.Index60) = cada2f1dY;
cada2td1(Gator2Data.Index61) = cada2td1(Gator2Data.Index61) + cada2f2dY;
cada2f3dY = cada2td1;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(64960,1);
cada2td1(Gator2Data.Index62) = cada2f3dY;
cada2td1(Gator2Data.Index63) = cada1td1dY(Gator2Data.Index64);
cada1td1dY = cada2td1;
cada1td1(Gator1Data.Index77) = cada2f3;
cada1f1dYdY = cada1td1dY; cada1f1dY = cada1td1;
cada1f1 = dX_quad.f - Fp.f;
cada1tf2dY = cada1f1dY(Gator2Data.Index65);
...
cada2td1(Gator2Data.Index69) = cada2td1(Gator2Data.Index69) + cada2tf1(:).*cada1f1dYdY;
cada1f2dYdY = cada2td1;
cada1f2dY = cada2f3.*cada1f1dY;
cada1f2 = cada1f1.^2;
cada1tf2dY = Gp.dY(Gator2Data.Index70);
cada1tf2 = Gp.f(Gator1Data.Index79);
cada2f1dY = cada1tf2dY;
cada2f1 = cada1tf2(:);
cada2tf2 = cada2f1(Gator2Data.Index71);
cada2f2dY = 1.*cada2tf2(:).^(1-1).*cada2f1dY;
cada2f2 = cada2f1.^1;
cada2f3dY = 2.*cada2f2dY;
cada2f3 = 2*cada2f2;
cada2tf1 = Gp.dY(Gator2Data.Index72);
cada2td1 = cada2tf1(:).*cada2f3dY;
cada2tf1 = cada2f3(Gator2Data.Index73);
cada2td1(Gator2Data.Index74) = cada2td1(Gator2Data.Index74) + cada2tf1(:).*Gp.dYdY;
cada1f3dYdY = cada2td1;
cada1f3dY = cada2f3.*Gp.dY;
cada1f3 = Gp.f.^2;
cada1td1 =  zeros(17264,1);
cada1td1dY = cada1f2dYdY;
cada1td1(Gator1Data.Index80) = cada1f2dY;
cada2td1 = zeros(415744,1);
cada2td1(Gator2Data.Index75) = cada1f3dYdY;
cada2td1(Gator2Data.Index76) = cada1td1dY(Gator2Data.Index77);
cada1td1dY = cada2td1;
cada1td1(Gator1Data.Index81) = cada1f3dY;
Res.dYdY = cada1td1dY; Res.dY = cada1td1;
...
cada2f1dY = Res.dY(Gator2Data.Index78);
cada2f1 = Res.f.';
cada2td1 = sparse(Gator2Data.Index79,Gator2Data.Index80,cada2f1dY,176,660);
cada2td1 = cada1td2.'*cada2td1;
cada2td1 = cada2td1(:);
cada1td2dY = full(cada2td1(Gator2Data.Index81));
cada1td2 = cada2f1*cada1td2;
cada1td1 =  zeros(844,1);
cada2f1dY = cada1td2dY(Gator2Data.Index82);
cada2f1 = cada1td2(Gator1Data.Index89);
cada1td1dY = cada2f1dY;
cada1td1(Gator1Data.Index90) = cada2f1;
cada1td2dY = Res.dYdY(Gator2Data.Index83);
cada1td2 = sparse(Gator1Data.Index91,Gator1Data.Index92,Res.dY,176,660);
cada2td2 = sparse(Gator2Data.Index84,Gator2Data.Index85,cada1f3dY,176,16);
cada2td2 = cada1td2.'*cada2td2;
cada2td1 = zeros(20616,1);
cada2td1(Gator2Data.Index87) = cada2td2(Gator2Data.Index86);
cada2td2 = sparse(Gator2Data.Index88,Gator2Data.Index89,cada1td2dY,176,19486);
cada2td2 = cada1f3*cada2td2;
cada2td2 = cada2td2(:);
cada2td1(Gator2Data.Index91) = cada2td1(Gator2Data.Index91) + cada2td2(Gator2Data.Index90);
cada1td2dY = cada2td1;
cada1td2 = cada1f3*cada1td2;
cada1td2 = cada1td2(:);
cada2f1dY = cada1td1dY(Gator2Data.Index92);
cada2f1 = cada1td1(Gator1Data.Index94);
cada2f2dY = cada1td2dY(Gator2Data.Index93);
cada2f2 = cada1td2(Gator1Data.Index93);
cada2td1 = zeros(20616,1);
cada2td1(Gator2Data.Index94) = cada2f1dY;
cada2td1 = cada2td1 + cada2f2dY;
cada2f3dY = cada2td1;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(20808,1);
cada2td1(Gator2Data.Index95) = cada2f3dY;
cada2td1(Gator2Data.Index96) = cada1td1dY(Gator2Data.Index97);
cada1td1dY = cada2td1;
cada1td1(Gator1Data.Index94) = cada2f3;
...
cada1f1 = Res_int.f(:);
cada1td1dY = cada1f1dYdY(Gator2Data.Index98);
cada1td1 = sparse(Gator1Data.Index95,Gator1Data.Index96,cada1f1dY,40,246);
cada2td1 = sparse(Gator2Data.Index99,Gator2Data.Index100,cada1td1dY,40,10394);
cada2td1 = data.ResConstScaleMat*cada2td1;
cada2td1 = cada2td1(:);
cada1td1dY = full(cada2td1(Gator2Data.Index101));
cada1td1 = data.ResConstScaleMat*cada1td1;
cada1td1 = cada1td1(:);
cada2f1dY = cada1td1dY(Gator2Data.Index102);
...
cada2f1dY = Res_int_Const.dYdY(Gator2Data.Index103);
cada2f1 = sparse(Gator1Data.Index98,Gator1Data.Index99,Res_int_Const.dY,8,662);
cada2td1 = sum(sparse(Gator2Data.Index104,Gator2Data.Index105,cada2f1dY,8,19814),1);
...
cada1f1dYdY = Res_int.dYdY; cada1f1dY = Res_int.dY;
cada1f1 = Res_int.f(:);
cada1td1dY = cada1f1dYdY(Gator2Data.Index106);
cada1td1 = sparse(Gator1Data.Index100,Gator1Data.Index101,cada1f1dY,40,246);
cada2td1 = sparse(Gator2Data.Index107,Gator2Data.Index108,cada1td1dY,40,10394);
cada2td1 = data.ResNormScaleMat*cada2td1;
cada2td1 = cada2td1(:);
cada1td1dY = full(cada2td1(Gator2Data.Index109));
...
cada2f1dY = Res_int_Norm.dYdY(Gator2Data.Index111);
cada2f1 = sparse(Gator1Data.Index103,Gator1Data.Index104,Res_int_Norm.dY,8,662);
cada2td1 = sum(sparse(Gator2Data.Index112,Gator2Data.Index113,cada2f1dY,8,19814),1);
cada1td1dY = full(cada2td1(:));
cada1td1 = sum(cada2f1,1);
cada2f1dY = cada1td1dY;
cada2f1 = cada1td1(:);
...
cada2f1dY = cada1f1dYdY(Gator2Data.Index114);
cada2f1 = sparse(Gator1Data.Index105,Gator1Data.Index106,cada1f1dY,5,246);
cada2td1 = sum(sparse(Gator2Data.Index115,Gator2Data.Index116,cada2f1dY,5,10394),1);
cada1td1dY = full(cada2td1(:));
cada1td1 = sum(cada2f1,1);
cada2f1dY = cada1td1dY;
cada2f1 = cada1td1(:);
...
ResNorm_intsum.dYdY_size = [ResNorm_intsum.dY_size,246];
ResNorm_intsum.dYdY_location = [ResNorm_intsum.dY_location(Gator2Data.Index117,:), Gator2Data.Index118];
Res_intsum.dYdY_size = [Res_intsum.dY_size,246];
Res_intsum.dYdY_location = [Res_intsum.dY_location(Gator2Data.Index119,:), Gator2Data.Index120];
end
