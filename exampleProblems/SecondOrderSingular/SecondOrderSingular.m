function [problem,guess] = SecondOrderSingular
%SecondOrderSingular - Second order singular regulator problem
%
...
InternalDynamics=@SecondOrderSingular_Dynamics_Internal;
SimDynamics=@SecondOrderSingular_Dynamics_Sim;
...
% Settings file
problem.settings=@settings_SecondOrderSingular;
...
problem.states.xErrorTol_integral=[1e-7];

% State constraint error bounds
problem.states.xConstraintTol=[1e-7];
problem.states.xrConstraintTol=[1e-7];

% Terminal state bounds. xfl=< xf <=xfu
problem.states.xfl=[-inf]; 
problem.states.xfu=[inf];
