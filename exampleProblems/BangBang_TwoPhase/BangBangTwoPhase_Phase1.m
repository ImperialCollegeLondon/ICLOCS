function [problem,guess] = BangBangTwoPhase_Phase1(problem_mp, guess_mp)
...
InternalDynamics=@BangBang_Dynamics_Phase1;
SimDynamics=[];
...
% Settings file
problem.settings=@settings_BangbangTwoPhase_Phase1;
