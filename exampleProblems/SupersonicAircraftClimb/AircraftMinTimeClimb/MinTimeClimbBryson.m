function [problem,guess] = MinTimeClimbBryson
%MinFuelClimbBryson - Supersonic Aircraft Minimum Time Climb Problem
%
...
InternalDynamics=@MinTimeClimbBryson_Dynamics_Internal;
SimDynamics=@MinTimeClimbBryson_Dynamics_Sim;
...
% Settings file
problem.settings=@settings_MinTimeClimbBryson;
