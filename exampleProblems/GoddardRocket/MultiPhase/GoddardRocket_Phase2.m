function [problem,guess] = GoddardRocket_Phase2(problem_mp, guess_mp)
...
guess.states(:,1)=[h_max/3 h_max/2];
guess.states(:,2)=[v_max/3 v_max];
guess.states(:,3)=[(m_max-m_min)/2+m_min m_min];
...
guess.inputs(:,1)=[T_max/2 T_max/2];
...
problem.constraints.gTol_eq=[0.1];
