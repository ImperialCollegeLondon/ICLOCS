...
cada1td1 = cada1td1(:);
X.dY = full(cada1td1(Gator1Data.Index3));
...
cada1td1 = cada1td1(:);
U.dY = full(cada1td1(Gator1Data.Index6));
...
%User Line: cadaconditional1 = strcmp(dataNLP.options.discretization,'globalLGR') | strcmp(dataNLP.options.discretization,'hpLGR');
    ...
    %User Line: cadaconditional1 = nt;
        ...
        cada1td2 = sparse(Gator1Data.Index59,Gator1Data.Index60,cada1f6dY,297,2610);
        cada1td2 = F.f.'*cada1td2;
        cada1td1 = zeros(26100,1);
