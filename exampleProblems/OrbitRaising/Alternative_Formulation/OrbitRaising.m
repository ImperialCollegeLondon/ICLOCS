...
problem.analyticDeriv.gradCost=@gradCost_OrbitRaising;
problem.analyticDeriv.hessianLagrangian=@hessianLagrangian_OrbitRaising;
problem.analyticDeriv.jacConst=@jacConst_OrbitRaising;
...
% State error bounds
problem.states.xErrorTol_local=[0.01 deg2rad(0.01) 0.01];
problem.states.xErrorTol_integral=[0.01 deg2rad(0.01) 0.01];

% State constraint error bounds
problem.states.xConstraintTol=[0.01 0.01 0.01];
