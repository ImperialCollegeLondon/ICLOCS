function [problem,guess] = Hypersensitive
%Hypersensitive - Hypersensitive problem
%
...
% State error bounds
problem.states.xErrorTol=1e-7;
% problem.states.xErrorTol=[1e-5 deg2rad(0.01) 1e-5 1e-5];
...
problem.data.plantmodel = 'HypersensitivePlant';
