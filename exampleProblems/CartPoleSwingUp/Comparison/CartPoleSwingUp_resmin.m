function [problem,guess] = CartPoleSwingUp_resmin
...
SimDynamics=@CartPoleSwingUp_Dynamics_Sim_Exact;
...
% Settings file
problem.settings=@settings_CartPoleSwingUp_resmin;
...
% problem.states.xErrorTol_integral=[10 10 10 10];

% State constraint error bounds
problem.states.xConstraintTol=[1e-5 1e-5 1e-5 1e-5];

problem.states.resNormCusWeight = [1 1 100 300];
...
% guessSol=load('guessSol.mat');
% guess.time=guessSol.T;
% guess.states=guessSol.X;
% guess.inputs=guessSol.U;
