function [problem,guess] = CartPoleSwingUp_resmin_costonly
...
% Settings file
problem.settings=@settings_CartPoleSwingUp_resmin_costonly;
...
problem.states.xErrorTol_integral=[1e-1 1e-1 1e-1 1e-1];
