function options = settings_CartPoleSwingUp_resmin_costonly(varargin)
...
% - Direct objective minimization solve ('directCostMin')                         direct solving the objective minimization problem with constraints on integrated residual
options.min_res_mode='directCostMin';
