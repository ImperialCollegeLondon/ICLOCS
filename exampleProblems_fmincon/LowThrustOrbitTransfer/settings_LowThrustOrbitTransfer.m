...
%---------------------------------------
options.fmincon.optimoptions = optimoptions('fmincon','Display','iter','SpecifyObjectiveGradient',true,'SpecifyConstraintGradient',true,'MaxIterations',300000,'MaxFunctionEvaluations',1000000,'ScaleProblem',true);
