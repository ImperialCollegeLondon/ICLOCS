...
options.fmincon.optimoptions = optimoptions('fmincon','Display','iter','SpecifyObjectiveGradient',true,'SpecifyConstraintGradient',true,'MaxIterations',5000,'MaxFunctionEvaluations',10000,'ScaleProblem',true);
