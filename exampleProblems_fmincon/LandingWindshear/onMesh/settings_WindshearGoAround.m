function options = settings_WindshearGoAround(varargin)
...
%---------------------------------------
options.fmincon.optimoptions = optimoptions('fmincon','Display','iter','SpecifyObjectiveGradient',true,'SpecifyConstraintGradient',true,'MaxIterations',5000,'ScaleProblem',true);
