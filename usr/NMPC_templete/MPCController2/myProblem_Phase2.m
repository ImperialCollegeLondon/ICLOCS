function [problem,guess] = myProblem_Phase2
...
InternalDynamics=@myProblem_Dynamics_Internal_Phase2; 
SimDynamics=[];

% Analytic derivative files (optional), provide in the format of function handle
problem.analyticDeriv.gradCost=@gradCost_myProblem_Phase2;
problem.analyticDeriv.hessianLagrangian=@hessianLagrangian_myProblem_Phase2;
problem.analyticDeriv.jacConst=@jacConst_myProblem_Phase2;

% Settings file
problem.settings=@settings_myProblem_Phase2;
