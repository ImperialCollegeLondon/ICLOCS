...
InternalDynamics=@myProblem_Dynamics_Internal_Phase1; 
SimDynamics=[];

% Analytic derivative files (optional), provide in the format of function handle
problem.analyticDeriv.gradCost=@gradCost_myProblem_Phase1;
problem.analyticDeriv.hessianLagrangian=@hessianLagrangian_myProblem_Phase1;
problem.analyticDeriv.jacConst=@jacConst_myProblem_Phase1;

% Settings file
problem.settings=@settings_myProblem_Phase1;
